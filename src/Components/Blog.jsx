...
const Blog = () => {
    ...
    return (
      ...
      {({loading}) => (loading ? <button>Loading Document...</button> : <div className='mt-2 flex justify-end'><button className='bg-yellow-400 rounded-xl font-semibold hover:bg-sky-300 duration-100 text-xl p-2' >Download this page</button></div>  )}
      </PDFDownloadLink>
